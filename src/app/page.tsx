...
function ContactSection() {
  return (
    <section className="py-12 text-base-content" id="contact">
      <div className="flex flex-col items-start space-y-4">
        <a
          href="mailto:m.razif.pramuda@gmail.com"
          className="flex items-center space-x-2 hover:text-neutral-content transition"
        >
          <FaEnvelope className="text-xl" />
          <span>m.razif.pramuda@gmail.com</span>
        </a>

        <a
          href="https://www.linkedin.com/in/muhammadrazif/"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center space-x-2 hover:text-neutral-content transition"
        >
          <FaLinkedin className="text-xl" />
          <span>linkedin.com/in/muhammadrazif</span>
        </a>

        <a
          href="https://github.com/razzzp"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center space-x-2 hover:text-neutral-content transition"
        >
          <FaGithub className="text-xl" />
          <span>github.com/razzzp</span>
        </a>
      </div>
    </section>
  );
...
export default function Home() {
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center text-base-content px-10 md:px-30 lg:px-50 xl:px-80">
        <FullPaddedSection>
          <div className="space-y-4 h-[70vh] flex flex-col justify-center">
            ...
            <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
              <li className="mr-5 shrink-0 text-xs">
                  <a className="block hover:text-neutral-content" href="https://github.com/razzzp" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)" title="GitHub">
                ...
                <li className="mr-5 shrink-0 text-xs">
                  <a className="block hover:text-neutral-content" href="https://www.linkedin.com/in/muhammadrazif/" target="_blank" rel="noreferrer noopener" aria-label="LinkedIn (opens in a new tab)" title="LinkedIn">
